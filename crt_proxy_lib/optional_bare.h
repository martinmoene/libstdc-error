...
// Copyright 2020 by Dusan Jovanovic
// Martin's bare optional stripped down to nanoptional
// no std and no exceptions
// Motivation: narrow usage exclusively for valstat types

// convince nonstd::optional we are on C++03
// so it is decoupled from the std lib completely
#define optional_CPLUSPLUS 199711L
// use nonstd optional
...
private:
    ...
    bool has_value_{ /* DBJ added initializers */};
    value_type value_{};
};
